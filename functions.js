...
// map проходит проверку true или false
//const born = scientist.map(elem => {
//const born = scientist.filter(elem => {
const born = scientist.filter((elem, indx, arr) => {
   return elem.year >= 1800 && elem.year < 1900;                     
});
//console.log(born);

// 2) знайти суму років скільки прожили всі вченні
const sumYearAllScientist = scientist.reduce(
  (acc, elem) => acc + (elem.passed - elem.year),
  0
);
//console.log(sumYearAllScientist);

// 3) Відсортувати вчених по алфавіту

// 4) Відсортувати вчених по даті народження
const sortNames = scientist.sort((a, b) =>
  (a.year < b.year? -1: 1));
